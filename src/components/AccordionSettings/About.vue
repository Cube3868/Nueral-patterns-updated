<template>
    <div>
        ...
        <div class="credits-section">
            <p>
                <a href="https://github.com/MaxRobinsonTheGreat/webgl-convolution" target="_blank">Original Concept & Development: Max Robinson</a>
            </p>
            <p>
                Enhanced Features & UI by: Briar Abney
            </p>
            <p>
                AI Co-programmer: Gemini
            </p>
        </div>
        <hr>
